-- Organisations are the tenants table, which every scoped table has carried
-- from the start and nothing ever filtered on. From here on it is filtered
-- on: an organisation's people see its clients and domains and nothing else.
--
-- Who belongs to an organisation is decided by an Entra security group. The
