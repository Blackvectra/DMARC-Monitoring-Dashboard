-- Roles within an organization, customer logins, and white-label branding.
--
-- Roles are Entra groups, like membership: one group per organization for
...
-- What the organization looks like: the accent color and logo in the
...
-- is the rest: organizations, groups, clients, providers, imports.
